<%@ Page Language="VB" AutoEventWireup="false" CodeFile="InsertKategori.aspx.vb" Inherits="UAS_Controler_InsertKategori" %>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="id_kategori" DataSourceID="dataKategori" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2">
            <Columns>
                ...
                <asp:TemplateField HeaderText="Aksi">
                    <ItemTemplate>
                        <asp:Button ID="Button1" runat="server" PostBackUrl='<%# Eval("id_kategori", "UpdateKategori.aspx?id_kategoriku={0}") %>' Text="Update" Width="100px" />
                        &nbsp;&nbsp;
                        <asp:Button ID="Button2" runat="server" PostBackUrl='<%# Eval("id_kategori", "DeleteKategori.aspx?id_kategoriku={0}") %>' Text="Delete" Width="100px" />
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
