<%@ Page Language="VB" AutoEventWireup="false" CodeFile="produkalarm.aspx.vb" Inherits="UAS_page_produkk" %>
...
<body>
       <div id="logodanfitur">
        ...
        <p style="font-family:Tw Cen MT;text-align:center;font-size:40pt">ALARM</p>
       ...
       <div id="contentproduktengah">
        <table align="center" class="tablekecil">
                <tr>
                    <td class="style1">
                    <asp:Image ID="Image2" runat="server" ImageUrl="~/UAS/image/al2.JPG" />
                    </td>
                </tr>
                <tr>
                    <td class="style2">
        ...
        <table align="center" class="tablekecil">
                <tr>
                    <td class="style1">
                    <asp:Image ID="Image1" runat="server" ImageUrl="~/UAS/image/al3.JPG" />
                    </td>
                </tr>
                <tr>
                    <td class="style2">
       ...
       <div id="contentprodukkiri">
            <table align="center" class="tablekecil">
                <tr>
                    <td class="style1">
                    <asp:Image ID="Image4" runat="server" ImageUrl="~/UAS/image/al4.JPG" />
                    </td>
                </tr>
                <tr>
                    <td class="style2">
       ...
       <div id="contentproduktengah">
        <table align="center" class="tablekecil">
                <tr>
                    <td class="style1">
                    <asp:Image ID="Image5" runat="server" ImageUrl="~/UAS/image/al5.JPG" />
                    </td>
                </tr>
                <tr>
                    <td class="style2">
